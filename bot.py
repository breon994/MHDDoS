...
BOT_TOKEN = "7400403726:AAFXpgT43SF7_AJ5-5__Iqvw9SsqHS9quXc"
ADMIN_ID = 5716408780
...
def handle_start(message):
    ...
    bot.reply_to(
        message,
        (
            "👋🏻 *Bem-vindo(a) ao CRASH BOT | BY BREONN, O Melhor bot de crash brasileiro atualmente!*"
